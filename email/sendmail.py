...
class CCSendMail:
    def __init__(self,host="smtp.qq.com",username='111111111@qq.com',password='*********'):
        ...
        self.fromAlias='group'
        self.from2='11111111111@qq.com'
...
def main():
    send=CCSendMail()    
    send.sendMoreHtml(['1111111@qq.com','222222222@qq.com'],u'CCDH测试',u'测试测试测试是测试')
